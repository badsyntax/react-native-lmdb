...
namespace rnlmdb {
    ...
    std::unordered_map<int, MDB_dbi> dbMap = std::unordered_map<int, MDB_dbi>();
    int dbiMapKey = 0;
    ...
    void install(jsi::Runtime &jsiRuntime, const char *docPath)
    {
        ...
        auto init = jsi::Function::createFromHostFunction(
            ...
            [](jsi::Runtime& runtime, const jsi::Value& thisValue, const jsi::Value* args, size_t count) -> jsi::Value {
                ...
                rc = mdb_env_open(env, fullDocPathStr.c_str(), MDB_CREATE, 0644);
        ...
        auto open = jsi::Function::createFromHostFunction(
            ...
            [](jsi::Runtime& runtime, const jsi::Value& thisValue, const jsi::Value* args, size_t count) -> jsi::Value {
                ...
                mdb_dbi_open(txn, dbName.c_str(), MDB_CREATE, &dbi);
                mdb_txn_commit(txn);
                dbMap[++dbiMapKey] = dbi;

                return jsi::Value(dbiMapKey);
            }
        );
